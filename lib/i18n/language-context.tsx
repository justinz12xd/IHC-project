...
const translations = {
  es: {
    ...
    "auth.forgotPasswordSubtitle": "Ingresa tu correo electrónico y te enviaremos instrucciones para recuperar tu cuenta",
    "auth.resetPasswordInstructions": "Te enviaremos un enlace para restablecer tu contraseña",
    ...
    "auth.passwordResetSent": "Hemos enviado un enlace de recuperación a",
    "auth.checkEmailInstructions": "Por favor, revisa tu correo y sigue las instrucciones",
    ...
    "auth.sendToAnotherEmail": "Enviar a otro correo",
  ...
  en: {
    ...
    "auth.forgotPasswordSubtitle": "Enter your email and we'll send you instructions to recover your account",
    ...
    "auth.passwordResetSent": "We've sent a recovery link to",
    "auth.checkEmailInstructions": "Please check your email and follow the instructions",
